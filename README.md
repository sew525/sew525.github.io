...
I decided to present similar data visualizations for this project because it shows a comparaison. This first set shows a change in the number of average days spent in Hawaii in 1999 and 2021. The second table shows a surpsing comparison: the average days spent in Hawaii continued to rise, even in the COVID pandemic. I found this to be interesting because as someone who lived in Hawaii over the pandemic, the state was empty. There were no tourists to be found for months. I would like to know the answer as to why the average days did not decline OR increase since the state made a 14 day quarantine manatory in the beginning of the pandemic.
